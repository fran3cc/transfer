...
class NiN(nn.Module):
    def __init__(self, num_classes=9):
        ...
        self.nin_block4 = NiNBlock(192, 256, kernel_size=3, stride=1, padding=1)  # New block
        self.nin_block5 = NiNBlock(256, 256, kernel_size=3, stride=1, padding=1)  # New block
        self.dropout = nn.Dropout(0.5)
        self.final_block = NiNBlock(256, num_classes, kernel_size=3, stride=1, padding=1)
        ...
        self.residual4 = nn.Conv2d(192, 256, kernel_size=1, stride=1, padding=0)
        self.residual5 = nn.Conv2d(256, 256, kernel_size=1, stride=1, padding=0)
